...
void Shader::LoadAttributes()
{
	...
	m_attrColors = glGetAttribLocation(m_programID, "colors");				//Get handle for the colors buffer
	m_attrNormals = glGetAttribLocation(m_programID, "normals");			//Get handle for the normals buffer
