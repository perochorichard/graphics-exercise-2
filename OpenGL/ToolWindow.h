...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->checkBoxRedChannel->Location = System::Drawing::Point(0, 0);
			...
			this->checkBoxGreenChannel->Location = System::Drawing::Point(0, 23);
			...
			this->checkBoxBlueChannel->Location = System::Drawing::Point(0, 46);
